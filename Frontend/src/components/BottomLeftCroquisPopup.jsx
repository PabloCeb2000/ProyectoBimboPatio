...
const BottomLeftCroquisPopup = ({total = 0, cargado = 0, inactivos = 0, vacio = 0}) => {
  return (
    <div className='flex flex-col gap-2'>
      <h3 className="text-xl font-medium ">Zona 2: Carga</h3>
...
export default BottomLeftCroquisPopup